...
export default function DashboardLayout({
  ...
  return (
    <>
      <nav className='bg-white border-b border-gray-200 fixed z-30 w-full dark:bg-slate-800 dark:border-slate-800'>
      ...
      <div className='flex overflow-hidden bg-white pt-16 dark:bg-slate-800'>
                ...
                <ul className='space-y-2 pb-2'>
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className='text-base capitalize text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700'
                      >
        ...
        >
          ...
          <p className='text-center text-sm text-gray-500 my-10 print:hidden  dark:text-slate-200'>
